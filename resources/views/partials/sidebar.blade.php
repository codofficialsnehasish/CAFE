<aside class="sidebar">
    ...
    <div>
        <a href="{{ route('dashboard') }}" class="sidebar-logo">
            {{-- <img src="{{ asset('assets/dashboard-assets/images/logo.png') }}" alt="site logo" class="light-logo">
            <img src="{{ asset('assets/dashboard-assets/images/logo-light.png') }}" alt="site logo" class="dark-logo">
            <img src="{{ asset('assets/dashboard-assets/images/logo-icon.png') }}" alt="site logo" class="logo-icon"> --}}
            <h6>YOUR LOGO</h6>
        </a>
    </div>
